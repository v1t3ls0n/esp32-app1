...
|---|---|---|
| ⁧חיישן המרחק משיעור 2 שולח "מישהו בדלת!" 🚪 — **[יש מדריך מוכן!](docs/project-doorbell-he.md)** והקוד ב-<span dir="ltr"><code>⁨firmware/esp32-doorbell⁩</code></span>⁩ | ⁧לחבר חומרה מוכרת לענן⁩ | ⭐ |
